...
/**
 *
 * Made by: victorpreston
 * 		 Mmjosh
 *
 * Descript:
 *
 * The extended functions for the shell_main.c
 */
 ...
 *
 * Return:
 * The constant showing the type of the command used
 * Description -
 * 		 EXTERNAL_COMMAND (1)-.
 *		 INTERNAL_COMMAND (2)-.
 *		 PATH_COMMAND (3)-.
...
int parse_command(char *command)
{
	...
	/**
	 * @check_path - checks the path  of the program file
	 *
	 */
...
/**
 * execute_command - a command is executed based on type
 * @tokenized_command:command with options
 * @command_type: shows the type of the command
 *
 *
 * Return: void
 *
...
/**
 * check_path - Finds the path of the command
...
/**
 * get_func - function retreival
 *
 * @command: checks mapping against the string
 *
...
/**
 * _getenv - value of venv variable
 * 
